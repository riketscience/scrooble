...
class Bag {
	...
	public function initialize ():Void {
		...
		tiles =    [new Tile (tileImages[0],"A",1),new Tile (tileImages[0],"A",1),new Tile (tileImages[0],"A",1),new Tile (tileImages[0],"A",1),new Tile (tileImages[0],"A",1),new Tile (tileImages[0],"A",1),new Tile (tileImages[0],"A",1),new Tile (tileImages[0],"A",1),new Tile (tileImages[0],"A",1),	
				   ...
				   new Tile (tileImages[15],"C",3), new Tile (tileImages[15],"C",3),
				   new Tile (tileImages[16],"C",10),
				   new Tile (tileImages[17],"C",3), new Tile (tileImages[17],"C",1), new Tile (tileImages[17],"C",1), new Tile (tileImages[17],"C",1), new Tile (tileImages[17],"C",1), new Tile (tileImages[17],"C",1),
				   new Tile (tileImages[18],"C",1), new Tile (tileImages[18],"C",1), new Tile (tileImages[18],"C",1), new Tile (tileImages[18],"C",1),
				   new Tile (tileImages[19],"C",1), new Tile (tileImages[19],"C",1), new Tile (tileImages[19],"C",1), new Tile (tileImages[19],"C",1), new Tile (tileImages[19],"C",1), new Tile (tileImages[19],"C",1),
				   new Tile (tileImages[20],"C",1), new Tile (tileImages[20],"C",1), new Tile (tileImages[20],"C",1), new Tile (tileImages[20],"C",1),
				   new Tile (tileImages[21],"H",4), new Tile (tileImages[21],"H",4),
				   new Tile (tileImages[22],"H",4), new Tile (tileImages[22],"H",4),
				   new Tile (tileImages[23],"H",10),
				   new Tile (tileImages[24],"H",4), new Tile (tileImages[24],"H",4),
				   new Tile (tileImages[25],"H",10),
				   new Tile (tileImages[26],"H",999), new Tile (tileImages[26],"H",999)];
